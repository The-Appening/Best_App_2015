...
public class WeekViewer extends ActionBarActivity implements WeekView.MonthChangeListener, WeekView.EmptyViewClickListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.eventcreate:
                Intent start = new Intent(this, Event.class);
                startActivity(start);
                return true;
    ...
    private void setupDateTimeInterpreter(final boolean shortDate) {
        mWeekView.setDateTimeInterpreter(new DateTimeInterpreter() {
            ...
            public String interpretTime(int hour) {
                return hour > 11 ? (hour + 1) + "" : (hour == 0 ? "12" : hour + " ");
            }
        });
    }
   ...
   /*
        ...
        int BeginHour = Event.getStartHour();
        int BeginMin = Event.getStartMin();
        int BeginDay = Event.getStartDay();
        int BeginMonth = Event.getStartMonth();
        int BeginYear = Event.getStartYear();
        int EndHour = Event.getEndHour();
        int EndMin = Event.getEndMin();
        int EndDay = Event.getEndDay();
        int EndMonth = Event.getEndMonth();
    ...
    */
    ...
    public void onEmptyViewClicked(Calendar time) {
        ...
        endTime.add(Calendar.MINUTE, 00);
        endTime.add(Calendar.DATE, 17);
        endTime.add(Calendar.DAY_OF_MONTH, 17);
        endTime.add(Calendar.MONTH, 6-1);
        endTime.add(Calendar.YEAR, 2015);

        // Create a new event.
        WeekViewEvent event = new WeekViewEvent(20, "Project", startTime, endTime);
